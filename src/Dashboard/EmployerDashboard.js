      ...
      >
        ...
        >
          ...
          <Typography variant="subtitle1" sx={{ fontSize: "1.2rem", fontWeight: "500" }}>
            The Ultimate Hiring Hub, Anytime, Anywhere
          </Typography>
        </Box>
      </Box>
       ...
       <Box sx={{
        ...
        <Grid container spacing={4}>
          <Grid item xs={12} md={6}>
            <Card sx={{border:"5px solid white",boxShadow:"20px",backgroundColor:"whitesmoke",marginLeft:"10%"}}>
              <CardContent>
          ...
          <Grid item xs={12} md={5}>
            <Card sx={{border:"5px solid white",boxShadow:"20px",backgroundColor:"whitesmoke",marginLeft:"10%"}} >
              <CardContent>
                ...
                <Button variant="outlined" color="primary" sx={{ mt: 1,textTransform:"none" }}>
                  Select Job
                </Button>
                <Button variant="outlined" color="primary" sx={{ mt: 1 ,textTransform:"none"}}>
                  Select Calendar
        ...
        <Box mt={4}>
          ...
          <Grid container spacing={2} >
            {[ 
              ...
              <Grid item xs={12} md={5} key={index} marginLeft="5%">
